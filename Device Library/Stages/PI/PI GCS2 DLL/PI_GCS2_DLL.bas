...
'/////////////////////////////////////////////////////////////////////////////
'// fast scan commands
Public Declare Function PI_AAP Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxes1 As String, ByVal dLength1 As Double, ByVal szAxis2 As String, ByVal dLength2 As Double, ByVal dAlignStep As Double, ByVal iNrRepeatedPositions As Long, ByVal iAnalogInput As Long);
Public Declare Function PI_FIO Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxis1 As String, ByVal dLength1 As Double, ByVal szAxis2 As String, ByVal dLength2 As Double, ByVal dThreshold As Double, ByVal dLinearStep As Double, ByVal dAngleScan As Double, ByVal iAnalogInput As Long);
Public Declare Function PI_FLM Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxis As String, ByVal dLength As Double, ByVal dThreshold As Double, ByVal iAnalogInput As Long, ByVal iDirection As Long);
Public Declare Function PI_FLS Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxis As String, ByVal dLength As Double, ByVal dThreshold As Double, ByVal iAnalogInput As Long, ByVal iDirection As Long);
Public Declare Function PI_FSA Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxis1 As String, ByVal dLength1 As Double, ByVal szAxis2 As String, ByVal dLength2 As Double, ByVal dThreshold As Double, ByVal dDistance As Double, ByVal dAlignStep As Double, ByVal iAnalogInput As Long);
Public Declare Function PI_FSC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxis1 As String, ByVal dLength1 As Double, ByVal szAxis2 As String, ByVal dLength2 As Double, ByVal dThreshold As Double, ByVal dDistance As Double, ByVal iAnalogInput As Long);
Public Declare Function PI_FSM Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szAxis1 As String, ByVal dLength1 As Double, ByVal szAxis2 As String, ByVal dLength2 As Double, ByVal dThreshold As Double, ByVal dDistance As Double, ByVal iAnalogInput As Long);
Public Declare Function PI_qFSS Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByRef piResult As Long);

Public Declare Function PI_FGC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szProcessIds As String, ByRef pdScanAxisCenterValueArray As Double, ByRef pdStepAxisCenterValueArray As Double);
Public Declare Function PI_qFGC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szProcessIds As String, ByRef pdScanAxisCenterValueArray As Double, ByRef pdStepAxisCenterValueArray As Double);
Public Declare Function PI_FRC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szProcessIdBase As String, ByVal szProcessIdsCoupled As String);
Public Declare Function PI_qFRC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szProcessIdsBase As String, ByVal szBuffer As String, ByVal iBufferSize As Long);
Public Declare Function PI_qTCI Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByRef piFastAlignmentInputIdsArray As Long, ByRef pdCalculatedInputValueArray As Double, ByVal iArraySize As Long);
Public Declare Function PI_SIC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal iFastAlignmentInputId As Long, ByVal iCalcType As Long, ByRef pdParameters As Double, ByVal iNumberOfParameters As Long);
Public Declare Function PI_qSIC Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByRef piFastAlignmentInputIdsArray As Long, ByVal iNumberOfInputIds As Long, ByVal szBuffer As String, ByVal iBufferSize As Long);
Public Declare Function PI_FDR Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineName As String, ByVal szScanAxis As String, ByVal dScanAxisRange As Double, ByVal szStepAxis As String, ByVal dStepAxisRange As Double, ByVal szParameters As String);
Public Declare Function PI_FDG Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineName As String, ByVal szScanAxis As String, ByVal szStepAxis As String, ByVal szParameters As String);
Public Declare Function PI_FRS Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineNames As String);
Public Declare Function PI_FRP Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineNames As String, ByRef piOptionsArray As Long);
Public Declare Function PI_qFRP Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineNames As String, ByRef piOptionsArray As Long);
Public Declare Function PI_qFRR Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineNames As String, ByVal iResultId As Long, ByVal szResult As String, ByVal iBufferSize As Long);
Public Declare Function PI_qFRRArray Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, ByVal szScanRoutineNames As String, ByRef iResultIds As Long, ByVal szResult As String, ByVal iBufferSize As Long);
Public Declare Function PI_qFRH Lib "PI_GCS2_DLL.dll" (ByVal ID As Long, BayVal szBuffer As String, ByVal iBufferSize As Long);
