...
namespace PI
{
	...
	public class GCS2
	{
		...
		*/
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qFRRArray")]					public static extern int qFRRArray(int ID, string szScanRoutineNames, int[] piResultIds, StringBuilder sResult, int iBufferSize);
        ...
        /////////////////////////////////////////////////////////////////////////////
        // Trajectory
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_TGA")]                       public static extern int TGA(int ID, int[] iTrajectoryIDsArray, double[] dTrajectoryValueArray, int iArraySize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_TGC")]                       public static extern int TGC(int ID, int[] iTrajectoryIDsArray, int iArraySize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_TGF")]                       public static extern int TGF(int ID, int[] iTrajectoryIDsArray, int iArraySize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_TGS")]                       public static extern int TGS(int ID, int[] iTrajectoryIDsArray, int iArraySize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qTGL")]                      public static extern int qTGL(int ID, int[] iTrajectoryIDsArray, int[] dTrajectorySizesArray, int iArraySize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_TGT")]                       public static extern int TGT(int ID, int iTrajectoryTiming);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qTGT")]                      public static extern int qTGT(int ID, ref int iTrajectoryTiming);
    }
}
