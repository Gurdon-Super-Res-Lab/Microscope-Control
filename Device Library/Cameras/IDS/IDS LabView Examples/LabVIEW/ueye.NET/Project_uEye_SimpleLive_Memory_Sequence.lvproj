...
<Project Type="Project" LVVersion="10008000">
	<Item Name="Mein Computer" Type="My Computer">
		...
		<Item Name="uEye_SimpleLive_Memory_Sequence.vi" Type="VI" URL="../Examples/uEye_SimpleLive_Memory_Sequence.vi"/>
		<Item Name="Abhängigkeiten" Type="Dependencies">
			<Item Name="instr.lib" Type="Folder">
				<Item Name="Error_Handling.vi" Type="VI" URL="../Library/Error_Handling.vi"/>
				<Item Name="SubVI_Example_StartLive.vi" Type="VI" URL="../Examples/Example Modules SubVIs/SubVI_Example_StartLive.vi"/>
				<Item Name="SubVI_Example_GetImageSize.vi" Type="VI" URL="../Examples/Example Modules SubVIs/SubVI_Example_GetImageSize.vi"/>
				<Item Name="SubVI_Example_MemoryAllocationSequence.vi" Type="VI" URL="../Examples/Example Modules SubVIs/SubVI_Example_MemoryAllocationSequence.vi"/>
